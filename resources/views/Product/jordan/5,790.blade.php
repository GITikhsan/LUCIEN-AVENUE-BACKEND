...
@include('partial.navbar')
    ...
    <title>Beli Air Jordan 1 Retro Low OG Zion Williamson Voodoo</title>
    <link
      rel="stylesheet"
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/5JT/5,790,000.png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/5JT/5,790,000(2).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/5JT/5,790,000(3).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/5JT/5,790,000(4).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
        </div>
...
<div class="mb-6">
  ...
  <p class="text-3xl font-bold text-gray-900">IDR 5,790,000</p>
</div>
...
<section class="py-10">
  <div class="mt-10 border-t-2 border-gray-300 pt-6">
    ...
    "Voodoo” take on the Air Jordan 1 Low OG is now arriving for spooky season. As the name suggests, the upcoming pairs
    arrive in a rustic patchwork build resembling a voodoo doll featuring mismatched hues of “Flax,” “Muslin,” “Fauna Brown,”
    “Oil Green,” “Sesame,” and “Moon Fossil.” Uppers utilize a mix of materials including hemp, canvas, and suede with exposed
    cross-stitching stretching along the side panels and lateral Swooshes. The smaller Swoosh on the mudguard, ball-and-wing
    logos on the heel tabs, and tongue tabs are inverted, meanwhile, eerie details include scribble embroidery distressing,
    cross embroidery on the toe box, and button-eyed skull patches on the heel counter. Rounding out the look are stylized
    insoles, pre-aged midsoles, and dark gum rubber outsoles.
    </p>
           ...
           <a href="#" class="text-black no-underline block">
            ...
            <div class="mt-3">
              <div class="text-xs font-bold min-h-[40px]">Air Jordan 1 Retro Low OG SP Travis Scott Velvet Brown</div>
               <div class="text-green-600 font-bold text-sm mt-1">IDR 4,240,000</div>
             </div>
           </a>
         </div>
