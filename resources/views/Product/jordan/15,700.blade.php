...
@include('partial.navbar')
    ...
    <title>Beli Air Jordan 1 Retro Low OG SP Travis Scott Reverse Mocha</title>
    <link
      rel="stylesheet"
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/15JT/15,700,000.png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/15JT/15,700,000(2).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/15JT/15,700,000(3).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/15JT/15,700,000(4).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
        </div>
...
<div class="mb-6">
  ...
  <p class="text-3xl font-bold text-gray-900">IDR 15,700,000</p>
</div>
...
<section class="py-10">
  <div class="mt-10 border-t-2 border-gray-300 pt-6">
    ...
    The Travis Scott x Air Jordan 1 Low OG ‘Reverse Mocha’ delivers a twist on the original ‘Mocha’ AJ1 Low from 2019.
    The upper combines a brown suede base with ivory leather overlays and the Houston rapper’s signature reverse Swoosh
    on the lateral side, featuring oversized dimensions and a neutral cream finish. Contrasting scarlet accents distinguish
    a pair of woven Nike Air tongue tags, as well as mismatched Cactus Jack and retro Wings logos embroidered on each heel
    tab. A vintage off-white rubber midsole is bolstered with encapsulated Nike Air cushioning in the heel and a brown rubber
    outsole underfoot.
    </p>
