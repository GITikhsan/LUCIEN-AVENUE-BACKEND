...
<div class="relative mb-8 px-4 md:px-10">
  <h3 class="text-sm font-semibold text-center">Similar Products</h3>
  <div class="absolute right-4 md:right-10 top-0">
  <a href="/products" class="inline-flex items-center gap-2 px-5 py-2 text-xs font-semibold text-white bg-black rounded-full hover:bg-gray-900 hover:scale-105 transition-transform duration-200 shadow-sm">
  <span>View More</span>
