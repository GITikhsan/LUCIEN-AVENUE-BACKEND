...
@include('partial.navbar')
    ...
    <title>Beli Air Jordan 1 Retro Low OG SP Travis Scott Medium Olive</title>
    <link
      rel="stylesheet"
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/7JT/7,950,000.png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/7JT/7,950,000(2).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/7JT/7,950,000(3).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="swiper-zoom-container zoom-follow">
              <img src="/images/7JT/7,950,000(4).png" alt="" class="w-full h-auto object-contain" />
            </div>
          </div>
        </div>
...
<div class="mb-6">
  ...
  <p class="text-3xl font-bold text-gray-900">IDR 7,950,000</p>
</div>
...
<section class="py-10">
  <div class="mt-10 border-t-2 border-gray-300 pt-6">
    ...
    The Jordan 1 Retro Low OG SP Travis Scott Medium Olive continues the highly coveted collaboration between Jordan Brand
    and Travis Scott, offering sneakerheads a fresh take on a classic silhouette. Dressed in a striking colorway of medium
    olive, black, sail, and muslin, this low-top design is instantly recognizable with its iconic reverse swoosh, a signature
    element of the Travis Scott x Jordan partnership. The premium leather and suede construction provides a tactile contrast,
    while the standout red Jordan wings logo on the heel and the Cactus Jack branding on the medial side elevate the sneaker’s
    distinctive style.
    </p>
