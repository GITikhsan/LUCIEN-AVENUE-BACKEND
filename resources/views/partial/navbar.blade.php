  ...
  <div class="absolute top-8 left-1/2 transform -translate-x-1/2 w-full max-w-2xl px-4">
    <div class="bg-white rounded-full shadow-lg flex items-center px-4 py-2">
      ...
      <button id="closeSearch" class="text-gray-500 hover:text-black text-xl">&times;</button>
            ...
            <div id="shoppingBagBox" class="absolute mt-4 w-[26rem] max-h-[34rem] bg-white rounded-2xl shadow-2xl right-0 top-full z-50 flex flex-col hidden">
              <!-- Header -->
              ...
              <div id="bagItems" class="flex-1 overflow-y-auto p-6 space-y-4">
                ...
                <template id="cartItemTemplate">
                  <div class="flex items-start gap-4 border-b pb-4 cart-item" data-price="0" data-qty="1">
                    <img src="/images/wanita jordan/1,590,000(1).webp" alt="Product" class="w-20 h-20 rounded-lg object-contain object-center p-1 bg">
                    <div class="flex-1">
                      <p class="font-semibold text-sm text-gray-800 item-name"></p>
                      <p class="text-sm text-gray-500">Size: <span class="font-medium text-gray-700 item-size"></span></p>
                      <p class="text-sm text-gray-500 mb-1 item-price"></p>
                      <div class="flex items-center mt-2 gap-2">
                        <button class="qty-decrease px-3 py-1 text-sm font-semibold rounded-full bg-gray-200 hover:bg-gray-300">−</button>
                        <span class="item-qty-display px-3 py-1 text-sm font-semibold bg-gray-100 rounded-full border border-gray-300">1</span>
                        <button class="qty-increase px-3 py-1 text-sm font-semibold rounded-full bg-gray-200 hover:bg-gray-300">+</button>
              ...
              <div class="flex items-start gap-4 border-b pb-4 cart-item" data-price="1540000" data-qty="2">
                ...
                <!-- Item 3 -->
                <div class="flex items-start gap-4 border-b pb-4 cart-item" data-price="1540000" data-qty="2">
                  <img src="/images/sepatu1.webp" alt="Product" class="w-20 h-20 rounded-lg object-contain object-center p-1 bg">
                  <div class="flex-1">
                    <p class="font-semibold text-sm text-gray-800">Nike Air Max</p>
                    <p class="text-sm text-gray-500">Size: <span class="font-medium text-gray-700">42</span></p>
                    <p class="text-sm text-gray-500 mb-1">Rp1.540.000</p>
              ...
              <div class="p-6 border-t">
                ...
                <button class="w-full bg-black text-white py-2 rounded-lg hover:bg-gray-800 transition">Checkout</button>
              </div>
            </div>
  ...
  function attachEventHandlers(container) {
    ...
    container.querySelector('.remove-item').addEventListener('click', () => {
      ...
      if (document.querySelectorAll('.cart-item').length === 0) {
        document.getElementById('bagItems').innerHTML = '<p class="text-center text-gray-500">Your bag is empty.</p>';
      }
    });
  }
